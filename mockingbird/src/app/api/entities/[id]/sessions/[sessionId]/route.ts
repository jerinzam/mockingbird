...
export async function GET(
  ...
  try {
    const { id: entityId, sessionId: sessionUUID } = await params;
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        session: {
          ...
          call_transcript: sessionData.call_transcript,
          call_started_time: sessionData.call_started_time,
          call_ended_time: sessionData.call_ended_time,
          call_ended_reason: sessionData.call_ended_reason,
