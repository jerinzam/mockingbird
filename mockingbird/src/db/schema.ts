...
import { integer, bigint,  pgTable, serial, text, timestamp, varchar, boolean, uuid,primaryKey, jsonb } from 'drizzle-orm/pg-core';
...
export const entitiesTable = pgTable('entities', {
  ...
  vapi_agent_id: varchar('vapi_agent_id', { length: 255 }),
  created_at: timestamp('created_at').defaultNow().notNull(),
  created_by: uuid('created_by').notNull()
});
